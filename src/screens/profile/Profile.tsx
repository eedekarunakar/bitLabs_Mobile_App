  ...
  if (error) {
    return (
      <View style={styles.errorContainer}>
        ...
        <Text onPress={() => reloadProfile()} style={styles.retryText}>
          Tap to Retry
        </Text>
      </View>
    );
          ...
          <View style={styles.card}>
            <View style={styles.container}>
              <View style={styles.pencil}>
                <TouchableOpacity
                  onPress={() => {
                    setPersonalDetailsFormVisible(true);
                    resetPersonalDetails();
                  }}>
              ...
              <View style={styles.imageContainer}>
                ...
                <TouchableOpacity
                  ...
                  accessible={true}
                  accessibilityLabel="Open Camera Options"
                  onPress={() => {
              ...
              <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                ...
                {verified && (
                  <Icon1 name="verified" size={25} color="#F46F16" style={{marginLeft: 5}} />
                )}
              </View>
          ...
          <View style={styles.professional}>
            ...
            <View style={{margin: 2}}>
              ...
              <View style={styles.skillContainer}>
                ...
                {skillsRequired.length > 0 &&
                  skillsRequired.map((skill: {id: number; skillName: string}, index: number) => (
            ...
            {isProfessionalFormVisible && (
              <ProfessionalDetailsForm
                ...
                onClose={() => {
                  setProfessionalFormVisible(false);
                  resetPersonalDetails();
                }}
              ...
              <Modal
                ...
                <View style={styles.modalView}>
                  <View style={styles.modalCard}>
                    ...
                    <TextInput
                      placeholder={basicDetails?.email || 'Email'}
                      placeholderTextColor="#B1B1B1"
                      editable={false}
                      style={styles.input}
                    />
              ...
              <View style={styles.modalCard1}>
                ...
                <View
                  style={[
                    ...
                    (showBorder || (hasResume && !isResumeRemoved)) && styles.showborder,
                  ]}>
                  {resumeFile ? (
                    <View style={{flexDirection: 'row'}}>
                ...
                <TouchableOpacity
                  style={[
                    ...
                    {alignItems: 'flex-end', marginBottom: 10, marginTop: 10},
                  ]}
                  ...
                  {isUploadComplete ? (
                    <View
                      ...
                      <Text style={[styles.saveButtonText, {fontFamily: 'PlusJakartaSans-Bold'}]}>
                        Save Changes
                      </Text>
                    </View>
                  ) : (
