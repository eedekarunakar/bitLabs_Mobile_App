...
const TestCompletionMessage = ({ message, buttonText, onPress, showLaterButton, navigation }:any) => (
  <>
      ...
      <View style={styles.Items}>
        <View style={styles.centeredView}>
          <Text style={styles.nameText}>
            Hi {basicDetails.firstName ? basicDetails.firstName.charAt(0).toUpperCase() + basicDetails.firstName.slice(1) : "Guest"},
          </Text>
          <View style={styles.score}>
            <MaskedView
              maskElement={<Text style={[styles.scoreText, styles.maskedText]}>You scored {roundedScore}%</Text>}
            >
              <LinearGradient colors={["#F97316", "#FAA729"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.gradientBackground} />
            </MaskedView>
          </View>
        </View>
