    ...
    <View style={styles.container}>
      <View style={styles.Items}>
          ...
          <>
            <View style={styles.messageContainer}>
              <Text style={styles.message}>
                Congratulations! You have successfully completed the General Aptitude Test
              </Text>
            </View>

            <Text style={styles.text}>Now you are eligible for{"\n"}the Technical Test</Text>
        ...
        {testName === "Technical Test" && (
          <>
            <View style={styles.messageContainer}>
              <Text style={styles.message}>Congratulations! You are now verified.</Text>
            </View>
            <TouchableOpacity
              style={styles.button}
        ...
        {testName !== "General Aptitude Test" && testName !== "Technical Test" && (
          <>
            <View style={styles.messageContainer}>
              <Text style={styles.message}>
                Congratulations! You are now verified for {testName} test
              </Text>
            </View>
            <TouchableOpacity
              style={styles.button}
