          ...
          <View>
            <View style={{ paddingHorizontal: 15 }}>
              ...
              >
                <TouchableOpacity onPress={handleUploadResume}>
                  ...
                  <View style={{ padding: 10 }}>
                    ...
                    <Text style={{ color: '#6C6C6C', textAlign: 'center', fontFamily: 'PlusJakartaSans-Medium' }}>
              ...
              <View style={{ marginBottom: 50 }}>
                {bgcolor ? (
                  <Text style={{ color: 'red', marginTop: 7, marginBottom: 22, fontFamily: 'PlusJakartaSans-Medium' }}>
                    File Not selected
                  </Text>
                ) : (
                  <Text></Text>
